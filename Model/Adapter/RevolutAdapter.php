...
class RevolutAdapter
{
    ...
    public function retrieve($params)
    {
        try {
            ...
            throw new LocalizedException(__("Internal Error Processing Payment Request"));
        }
    }
    ...
    public function capture($params)
    {
        try {
            ...
            $this->logger->debug('can capture orderId: ' .
                                $this->revolutOrder->getRevolutOrderId() . ' ' . $canCapture);
            ...
            try {
                if ($this->revolutOrder->getIncrementOrderId()) {
                    ...
                    $order = $this->orderFactory->create()->loadByIncrementId(
                        $this->revolutOrder->getIncrementOrderId()
                    );
            ...
            if ($canCapture) {
                ...
                throw new LocalizedException(__('Can not capture order. Payment state: ' .
                                        $this->revolutOrder->revolutOrder['state']));
            }
