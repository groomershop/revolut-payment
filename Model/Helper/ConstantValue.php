...
class ConstantValue
{
    ...
    public const MAGENTO_PAYMENT_REVIEW_STATUS = 'payment_review';
    ...
    public const SUPPORTED_CURRENCIES = [ 'AED', 'AUD', 'BGN', 'CAD', 'CHF', 'CZK', 'DKK', 'EUR',
     'GBP', 'HKD', 'HUF', 'ILS', 'ISK', 'JPY', 'MXN', 'NOK', 'NZD', 'PLN', 'QAR',
      'RON', 'SAR', 'SEK', 'SGD', 'THB', 'TRY', 'USD', 'ZAR' ];

    public const CARD_GATEWAY_SUPPORTED_CURRENCIES = ['AUD', 'CAD', 'CHF', 'CZK',
    'DKK', 'EUR', 'GBP', 'HKD', 'HUF', 'JPY', 'NOK', 'NZD',
    'PLN', 'RON', 'SEK', 'SGD', 'USD', 'ZAR', 'BGN', 'MXN', 'TRY', 'ILS' ];
    
    public const SUPPORT_LINK =  'https://www.revolut.com/en-HR/business/help' .
                                 '/merchant-accounts/payments/in-which-currencies-can-i-accept-payments';
}
