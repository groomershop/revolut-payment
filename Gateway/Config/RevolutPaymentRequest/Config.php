...
{
    public const TITLE = 'ApplePay - GooglePay';
    ...
    /**
     * Get PaymentRequestButtonStyleConfigs
     *
     * @param int $storeId
     * @return array
     */
    public function getPaymentRequestButtonStyleConfigs($storeId = 0)
    {
        $size = $this->getValue('size', $storeId);
        $action = $this->getValue('action', $storeId);
        $theme = $this->getValue('theme', $storeId);
