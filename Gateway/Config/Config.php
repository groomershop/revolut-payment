...
class Config extends \Magento\Payment\Gateway\Config\Config
{
    ...
    public const AVAILABLE_CARD_BRANDS_LIVE = 'available_card_brands_live';
    public const AVAILABLE_CARD_BRANDS_SANDBOX = 'available_card_brands_sandbox';
...
/**
    ...
    /**
     * Get AddressValidationWebhookSetupResult
     *
     * @param int $storeId
     * @return int
     */
    ...
    /**
     * Save AddressValidationWebhookSetupUrl
     *
     * @param string $url
    ...
    {
        $this->configInterface->saveConfig(
            self::CONFIG_CODE . self::ADDRESS_VALIDATION_WEBHOOK_URL
            . '_' . $this->getModeName($storeId) . '_' . $locationId,
            (string)$url,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    ...
    /**
     * Get AddressValidationWebhookSetupUrl
     *
     * @param string $locationId
     * @param int $storeId
     * @return mixed
    ...
    /**
     * Save AddressValidationWebhookSetupSigningKey
     *
...
/**
     ...
     * @return mixed
     */
    public function getAvailableCardBrands($storeId = 0)
    {
        $cacheKey = $this->isLiveMode($storeId) ? 
            self::AVAILABLE_CARD_BRANDS_LIVE : self::AVAILABLE_CARD_BRANDS_SANDBOX;
        return $this->cacheConfig->load($cacheKey ."_". $storeId);

    }

    /**
     * Save Available Card Brands
     *
     * @param string $availableCardBrands
     * @param int $storeId
     * @return mixed
     */
    public function saveAvailableCardBrands($availableCardBrands, $storeId)
    {
        $cacheKey = $this->isLiveMode($storeId) ? 
            self::AVAILABLE_CARD_BRANDS_LIVE : self::AVAILABLE_CARD_BRANDS_SANDBOX;
        
        $this->cacheConfig->save($availableCardBrands, $cacheKey . "_" . $storeId, [], 86400);
    }
