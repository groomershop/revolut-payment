...
class AddressValidationWebhookSetup extends Field
{
    /**
     * @var string
     */
    protected $_template = 'Revolut_Payment::system/config/address_validation_webhook_setup.phtml';
    ...
    /**
     * Get AddressValidationWebhookSetupAjaxUrl
     *
     * @return string
     */
    public function getAddressValidationWebhookSetupAjaxUrl()
    {
        return $this->getUrl(
            'revolut/webhook/setup',
            ['address-validation' => 1, 'store' => $this->getRequest()->getParam('store', 0)
            ]
        );
    }
